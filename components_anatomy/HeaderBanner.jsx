...
<header className={ `${styles.animated} ${styles.fadeInDown} ${styles.header}`}>
<ul>
<li className={styles.social}><a href="#" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" version="1.0" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50"  className="icon icons8-Facebook-Filled" ><path d="M40,0H10C4.486,0,0,4.486,0,10v30c0,5.514,4.486,10,10,10h30c5.514,0,10-4.486,10-10V10C50,4.486,45.514,0,40,0z M39,17h-3 c-2.145,0-3,0.504-3,2v3h6l-1,6h-5v20h-7V28h-3v-6h3v-3c0-4.677,1.581-8,7-8c2.902,0,6,1,6,1V17z" style={{fill:'#fff'}}></path></svg>
 <span className={styles.sronly}>Facebook</span></a></li>
...
<section className={styles.banner}>
  <video playsInline autoPlay loop muted poster="/bg.jpg" >
   <source src='/bg-small.mp4' type='video/mp4' />
 </video>
<div className={styles.bannercontent}>

    <div className={styles.row}>
        <div className={`${styles.textsec}  ${styles.animated} ${styles.fadeInDown} ${styles.delay1} `}>
            ...
            <p>Get ready to delete your delivery app!<br></br><b>Runners Keep 100% & Local Businesses Keep 100%</b></p>
...
<div className={isActive ? "col col-12 col-md-3 "+styles.togglelabel : "col col-12 col-md-3 "+styles.labelToggle } onClick={checkActive}>
<label htmlFor="full_name">Your Name*</label>
<input type="text" id="full_name" className="formField" name="full_name" placeholder={namePH} onClick={NamePH}  required=""/>
</div>
<div className={isActive ? "col col-12 col-md-4 "+styles.togglelabel :  "col col-12 col-md-4 "+styles.labelToggle } onClick={checkActive}>
